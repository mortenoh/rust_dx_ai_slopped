//! # dx-expr - Expression Evaluation Library
//!
...
//!
//! ```
//! use dx_expr::{eval, parse, eval_program, Context};
//!
//! // Basic arithmetic
...
//! ctx.set("radius", 5.0);
//! let area = dx_expr::eval_with_context("pi * radius ^ 2", &mut ctx).unwrap();
